...
function updateHamsterLevel() {
	document.getElementById("big_hamster").style.cssText = "background-image: url('pics/hamsters/upgrades/world_" + worldlevel + "/level_" + hamsterlevel + ".png');";
}

function updateWorldLevel() {
	document.getElementById("game_background_far").style.cssText = "background-image: url('pics/world/level_" + worldlevel + "/back_far.png');";
